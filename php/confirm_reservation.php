...
$query = "INSERT INTO `reserve` (Bus_No, rDate, status, cancel, email, DeptTime, route, seatplan, tPrice, Trip_Code, tDate, reservation_num)
          VALUES ('".$bus_no."', '".$date."', '".$status."', '".$cancel."', '".$email."', '".$dept_time."', '".$route."', '".$seatplan."', '".$price."', '".$trip_code."', '".$trans_date."', '".$reservation_num."');";
